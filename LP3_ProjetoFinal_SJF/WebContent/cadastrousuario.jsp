...
<%@ taglib prefix="h"  uri="http://java.sun.com/jsf/html"%>
	...
	<f:view>
		<h:form styleClass="form-horizontal">
			...
			<h:inputText styleClass="form-control" id="inputnome" required="true" value="#{usuarioController.usuario.nome}"></h:inputText></td>
			...
			<h:commandButton styleClass="btn btn-success" value="Cadastrar" action="#{usuarioController.addUsuario}"/> </td>
