...
<div id="interacao-menu">
	...
	<h:form>
		<table>
			<tr>
				<td> Usuario a ser editado </td> 
				<td><h:inputText required="true" value="#{usuarioController.nome}"></h:inputText></td>
			</tr>
			...
			<tr>
				<td colspan="2"> <h:commandButton value="Confirma" action="#{usuarioController.alteraUsuario}"/> </td>
