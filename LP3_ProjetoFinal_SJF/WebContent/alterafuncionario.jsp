	...
	<f:view>
		<h:form id="form-cadastro" styleClass="form-horizontal">
			...
			<div class="form-group">
				<label for="inputnomealtera" class="col-sm-2 control-label">Nome</label>
				<h:inputText styleClass="form-control" id="inputnomealtera" required="true" value="#{funcionarioController.nome}"></h:inputText>
			</div>
			<div class="form-group">
				<h4>Novos Dados</h4>
			</div>
